...
def load_model_and_scaler():
    ...
    std_scaler = pickle.load(open('D:/Projects/FAANG/standard_scaler.pkl', 'rb'))
...
debt_to_equity_label_encoder = pickle.load(open('D:/Projects/FAANG/debt_to_equity_label_encoder.pkl', 'rb'))
eps_label_encoder = pickle.load(open('D:/Projects/FAANG/eps_label_encoder.pkl', 'rb'))
pe_ratio_label_encoder = pickle.load(open('D:/Projects/FAANG/pe_ratio_label_encoder.pkl', 'rb'))
price_to_book_ratio_label_encoder = pickle.load(open('D:\Projects\FAANG\price_to_book_ratio_label_encoder.pkl', 'rb'))
